        ...
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-slate-800 shadow-2xl space-y-8 text-sm text-slate-300 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-slate-400 text-xs sm:text-sm">
              <li>
                <strong className="text-slate-200">Purpose of Collection:</strong> GPS data is utilized solely to route complaints to the designated jurisdictional District Sub-Admin (Municipal Ward Officer) and to enable distance-based ranking on the public feed.
              </li>
              <li>
                <strong className="text-slate-200">No Background Tracking:</strong> Location coordinates are captured only upon user initiation when opening the live reporting module or viewing nearby grievances. CivicLens never tracks your location in the background when the application is closed.
              </li>
              <li>
                <strong className="text-slate-200">Anti-Tamper Geofencing:</strong> Location coordinates are cryptographically hashed and watermarked onto grievance records to enforce our 100-meter officer resolution verification rule.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-slate-400 text-xs sm:text-sm">
              <li>
                <strong className="text-slate-200">Canvas Watermarking:</strong> Real-time latitude, longitude, and timestamps are rendered permanently onto image bytes using HTML5 Canvas before upload.
              </li>
              <li>
                <strong className="text-slate-200">AI Vision Verification:</strong> Images are processed through Groq Vision AI to validate authentic municipal infrastructure damage (potholes, garbage, sewage, streetlights). Personal portraits, selfies, personal electronic screens, and indoor furniture are automatically rejected to preserve personal privacy.
              </li>
              <li>
                <strong className="text-slate-200">Public Display:</strong> Verified infrastructure photos are published on the open community grievance feed to ensure civic accountability. Citizens should not photograph private domestic spaces or non-consenting individuals.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-slate-400 text-xs sm:text-sm">
              <li><strong className="text-slate-200">Name and Email Address:</strong> Used for grievance authentication, OTP verification, and status notifications.</li>
              <li><strong className="text-slate-200">Phone Number (Optional):</strong> Used by municipal dispatch teams to contact citizens if additional on-site navigation guidance is required.</li>
              <li><strong className="text-slate-200">No Data Monetization:</strong> We do not sell, rent, or monetize citizen contact information to commercial advertising third parties under any circumstances.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-slate-400 text-xs sm:text-sm">
              <li>
                <strong className="text-slate-200">Authorized Municipal Officers:</strong> Assigned District Sub-Admins, Public Works Department (PWD), Electricity Boards, and Municipal Corporations responsible for field maintenance.
              </li>
              <li>
                <strong className="text-slate-200">State Governance Super-Admins:</strong> State-level oversight officials monitoring resolution SLAs, department performance, and escalation disputes.
              </li>
              <li>
                <strong className="text-slate-200">Public Community Feed:</strong> Aggregated, geotagged infrastructure reports (with citizen personal emails concealed) to maintain public civic transparency.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 bg-slate-800/60 border border-slate-700/80 rounded-2xl text-xs space-y-1 font-mono text-slate-300">
              <div>Email: <strong className="text-sky-400">privacy@civiclens.gov.in</strong></div>
